...
class Settings(BaseSettings):
    ...
    app_cors_origin_regex: str | None = r"^https?://(localhost|127\.0\.0\.1|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|172\.(1[6-9]|2\d|3[0-1])\.\d+\.\d+)(:\d+)?$"
    ...
    media_max_upload_size_mb: int = 20
    media_max_video_upload_size_mb: int = 30
